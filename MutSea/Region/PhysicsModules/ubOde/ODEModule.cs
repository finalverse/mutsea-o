...
{
    [Extension(Path = "/MutSea/RegionModules", NodeName = "RegionModule", Id = "ubODEPhysicsScene")]
        ...
        public void Initialise(IConfigSource source)
        {
            ...
            if (config != null)
            {
                ...
                if (physics == Name)
                {
                    ...
                    {
                        m_log.Error("[ubODE] MutSea.ini meshing option must be set to \"ubODEMeshmerizer\"");
